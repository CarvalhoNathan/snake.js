// Carregando o snake com uma váriavel chamada "canvas".
let canvas = document.getElementById('snake');
// Contexto é a renderização do canvas que vai trabalhar com um plano 2D.
